...
const ExtraLogos = () => {
  ...
  return (
    <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
      ...
      <ul
        role="list"
        className="mx-auto mt-8 flex max-w-screen-xl flex-wrap justify-center gap-x-10 gap-y-8 lg:mx-0 lg:justify-start"
      >
        {logos.map(({ title, _id, logo }) => (
          <li key={_id}>
            <Image src={logo} alt={title} className="h-8" unoptimzed />
          </li>
        ))}
      </ul>
    </div>
